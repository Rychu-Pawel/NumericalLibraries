...
using Rychusoft.NumericalLibraries.FourierTransform;
...
namespace Rychusoft.NumericalLibraries.Chart
{
    ...
    // Metody -----------------------------
        ...
        public void Draw(FunctionTypeEnum functionType)
        {
            ...
            Rychusoft.NumericalLibraries.Derivative.Derivative functionInThePoint = new Derivative.Derivative(function);
